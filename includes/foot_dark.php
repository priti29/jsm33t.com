<style>
   ...
   border: 1px solid rgba(255, 255, 255, 0.493)!important;
   }
   ...
   color: rgba(255, 255, 255, 0.623) !important;
            ...
            <footer class="page-section bg-black footer pb-60">
            <div class="container">
                ...
                <div class="footer-text">
                    <div class="footer-copy font-alt">
                        JSM33T / <?php echo date("d.m.y") ?>
                    </div>
                    <div class="footer-made">
                        Made with &nbsp;<i class="fa fa-heart"></i>&nbsp; for you all.
                    </div>
                </div>
            </div>
    ...
    <svg class="cursor" width="150" height="150" viewBox="0 0 220 220">
       ...
       <!--     <a href="#" target="_blank" class="buy-button"><i class="fa fa-search" aria-hidden="true"></i> <span>Test</span></a> -->
