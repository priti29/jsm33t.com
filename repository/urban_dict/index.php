...
if(isset($_POST['submit'])) 
{
 ...
 //	{
     ...
     echo "<h5 class='widget-title font-alt'><b>".count($elem)." </b>results found for <b>".$elem[0]['word']."</b></h5><div class='widget-body'> <div class='tags'>";
         
                 for ($x = 0; $x < count($elem); $x++) 
                 {
                     echo "<a><b>".($x+1).".</b>&nbsp;".( $elem[$x]['definition']). "<br>";
                     echo "<b> Example</b>&nbsp;".( $elem[$x]['example']). "</br>";
                     echo "<a><i class='fa fa-thumbs-up'></i>&nbsp;".( $elem[$x]['thumbs_up'])."</a>&nbsp;";
                     echo "<a><i class='fa fa-thumbs-down'></i>&nbsp;".( $elem[$x]['thumbs_down']). "</a></a></br>";
                     echo "</br>";
